...
public interface ReviewDAO {
	...
	ArrayList<ReviewVO> getAllReview(@Param("page") int page,@Param("page2") int page2);
	...
	//자기리뷰조회
	ArrayList<ReviewVO> myReview(@Param("page") int page,@Param("page2") int page2,@Param("mem_num") int mem_num);
