...
<div class="my_wrapper">
	...
	<div class="page-title">
		<div class="container">
			<h2 class="company_name">룸 전체보기</h2>
			<div class="search_bx">
				<form class="look_all"><button type="submit" class="mini_bk_btn">전체 파티룸 보기</button></form>
			</div>
		</div>
	</div>
	...
	<form action="roomAllPageFilter.do">
	...
	<c:forEach var="i" items="${rlist}" varStatus="status">
		...
		<div class="card">
			...
			&music=${i.music}&explanation=${i.explanation}&room_img_1=${i.room_img_1}&room_img_2=${i.room_img_2}&room_img_3=${i.room_img_3}&room_name=${i.room_name}
